...
1. Value function iteration solving the [Arellano (2008)](https://www.aeaweb.org/articles?id=10.1257/aer.98.3.690) model on a fine grid,[^2] and
2. Reading, and cleaning 615 GB (compressed) of data.[^1]
